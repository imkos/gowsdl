...
* In Github, fork `https://github.com/imkos/gowsdl` to your own account
* Get the package using "go get": `go get github.com/imkos/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/imkos/gowsdl/`
